...
. "$HUTBOT_ENV_FILE"
set +a
jq -n '$ENV | {SLACK_APP_TOKEN, SLACK_BOT_TOKEN, OPSGENIE_TOKEN, OPSGENIE_API_TOKEN,
               OPSGENIE_HEARTBEAT_NAME, EMPLOYEE_LIST_USERNAME, EMPLOYEE_LIST_PASSWORD,
               EMPLOYEE_LIST_MAPPINGS, HUTBOT_CALENDAR_BRIDGE_URL}
